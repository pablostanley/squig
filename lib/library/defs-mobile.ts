...
export const mobileFeedDef: ComponentDef = {
  ...
  controls: [
    ...
    { key: "tabs", label: "Tabs", help: "Separate items with commas.", type: "text" },
    { key: "posts", label: "Post titles", help: "Separate items with commas.", type: "text" },
    { key: "navLabels", label: "Tab bar", help: "Separate items with commas.", type: "text" },
...
export const mobileSettingsDef: ComponentDef = {
  ...
  controls: [
    ...
    { key: "groups", label: "Sections", help: "Separate items with commas.", type: "text" },
    { key: "rows", label: "Rows", help: "Separate items with commas.", type: "text" },
    { key: "navLabels", label: "Tab bar", help: "Separate items with commas.", type: "text" },
