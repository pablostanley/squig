...
try {
  ...
  await expect(page.getByText("Invite your agent to this canvas. Changes save automatically in this browser.")).toBeVisible()
  await expect(page.getByRole("button", { name: "Copy for your agent", exact: true })).toBeVisible()
  await page.getByRole("button", { name: "Copy for your agent", exact: true }).click()
