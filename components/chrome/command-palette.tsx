...
function Palette() {
  ...
  const actions = useMemo<Action[]>(
    () => [
      ...
      { id: "front", label: "Bring to front", hint: kbd("mod+]"), section: "Arrange", icon: StackIcon, disabled: !hasSel, run: () => st().bringToFront(st().selection) },
      { id: "back", label: "Send to back", hint: kbd("mod+["), section: "Arrange", icon: StackIcon, disabled: !hasSel, run: () => st().sendToBack(st().selection) },
      { id: "forward", label: "Bring forward", hint: kbd("alt+mod+]"), section: "Arrange", icon: StackSimpleIcon, disabled: !hasSel, run: () => st().bringForward(st().selection) },
      { id: "backward", label: "Send backward", hint: kbd("alt+mod+["), section: "Arrange", icon: StackSimpleIcon, disabled: !hasSel, run: () => st().sendBackward(st().selection) },
